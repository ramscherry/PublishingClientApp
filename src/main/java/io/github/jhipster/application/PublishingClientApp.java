...
public class PublishingClientApp {

    private static final Logger log = LoggerFactory.getLogger(PublishingClientApp.class);

    private final Environment env;

    public PublishingClientApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes PublishingClientApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PublishingClientApp.class);
